...
(
    ...
    claimable_item_instance_id BIGINT UNSIGNED GENERATED ALWAYS AS
    ...
    INDEX idx_attachment_item_history (item_instance_id, attachment_id),
    UNIQUE INDEX uq_claimable_attachment_item (claimable_item_instance_id),
